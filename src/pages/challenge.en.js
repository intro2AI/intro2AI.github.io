...
const Challenge = () => {
  return (
    <ChallengePage
      ...
      aboutContent={[
       'In this section we provide you with a curated list of Modern AI tools which will help you explore the space of all images with words as knobs. How many <a href="https://www.reddit.com/r/BrandNewSentence/" style="text-decoration: underline;">brand new sentences</a> can out imagination stitch together? ',
      ]}
      joinContent={[
